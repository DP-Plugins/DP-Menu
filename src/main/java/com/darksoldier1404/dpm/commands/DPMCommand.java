...
public class DPMCommand {
    ...
    public DPMCommand() {
        ...
        builder.addSubCommand("reload", "dpm.admin", lang.get("help_reload"), true, (p, args) -> {
            if (args.length == 3) {
                plugin.data.reload();
        ...
        builder.addSubCommand("action", "dpm.admin", lang.get("help_action"), false, (p, args) -> {
            if (args.length == 2) {
