...
public class DPMCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String s, @NotNull String[] args) {
        ...
        if (args.length == 0) {
            ...
            if (p.hasPermission("dpm.admin")) {
                ...
                p.sendMessage(plugin.data.getPrefix() + "/dpm action <name> - 메뉴의 액션을 설정합니다.");
        ...
        if(args[0].equalsIgnoreCase("test")) {
            ActionGUI gui = new ActionGUI(plugin);
        ...
        if (args[0].equalsIgnoreCase("action")) {
            ...
            DPMFunction.openActionSettingGUI(p, args[1]);
            return false;
        }
    ...
    public List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String s, @NotNull String[] args) {
        ...
        if(args.length == 2) {
            if (sender.hasPermission("dpm.admin")) {
                if (args[0].equalsIgnoreCase("create") || args[0].equalsIgnoreCase("delete") || args[0].equalsIgnoreCase("title") || args[0].equalsIgnoreCase("row") || args[0].equalsIgnoreCase("items") || args[0].equalsIgnoreCase("cmds") || args[0].equalsIgnoreCase("op") || args[0].equalsIgnoreCase("sound") || args[0].equalsIgnoreCase("cwc") || args[0].equalsIgnoreCase("price") || args[0].equalsIgnoreCase("aliases")) {
